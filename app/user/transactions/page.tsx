...
import { dashboardCategories, paymentItems } from "@/utils/constants";
...
const Transactions = () => {
    ...
    const { transactions, setTransactions, getDatas, totalAmount } = useTransactions()
                        ...
                        <>
                            ...
                            <TableFooter>
                                <TableRow>
                                    ...
                                    <TableCell colSpan={3} className="font-medium text-left">₹ {totalAmount}</TableCell>
                                </TableRow>
                            </TableFooter></>
                    ) : (
                        <TableBody>
